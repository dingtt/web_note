...
export default {
    ...
    'pagePath': "JXS  React.createElement 运行时.md",
    'layoutPath': "_layout.tsx",
    'outputPath': "JXS  React.createElement 运行时.html",
    'title': undefined,
    'content': React.createElement("article", { dangerouslySetInnerHTML: {
            __html: '<p>JXS  React.createElement 运行时</p>\n<p>react</p>\n<p>Runtime</p>\n<p>immutable</p>\n<p>不可变数据</p>\n<p>原生 vdom JSX</p>\n<p>计算数据diff</p>\n<p>vue</p>\n<p>Compiler</p>\n<p>Mutable</p>\n<p>Template</p>\n<p>可变数据 依赖收集</p>\n<p>抽象</p>\n<p>Reactivy + vdom</p>'
        } }),
    ...
    'updated': null,
    'excerpt': "JXS React.createElement 运行时 react Runtime immutable 不可变数据 原生 vdom JSX 计算数据diff vue Compiler Mutable Template 可变数据 依赖收集 抽象 Reactivy + vdom",
    'cover': undefined,
    'sidebar': [
        {
            "text": "Hello world",
